const abi = [
  ...
  { inputs: [], name: "currentIssueId", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [{ internalType: "bytes", name: "signature", type: "bytes" }], name: "mint", outputs: [], stateMutability: "nonpayable", type: "function" },
  ...
  { inputs: [{ internalType: "uint256", name: "newId", type: "uint256" }], name: "setCurrentIssueId", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [{ internalType: "address", name: "newAddress", type: "address" }], name: "setSignerAddress", outputs: [], stateMutability: "nonpayable", type: "function" },
  ...
  { inputs: [{ internalType: "address", name: "", type: "address" }], name: "team", outputs: [{ internalType: "bool", name: "", type: "bool" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "toggleMint", outputs: [], stateMutability: "nonpayable", type: "function" },
  { inputs: [{ internalType: "address", name: "teamAddress", type: "address" }], name: "toggleTeamAddress", outputs: [], stateMutability: "nonpayable", type: "function" },
